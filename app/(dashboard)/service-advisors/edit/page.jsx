...
const EditServiceAdvisor = () => {
    ...
    const updateserviceAdvisor = async () => {

        toast.loading('Updating serviceAdvisor..');
        ...
        if (response.ok) {
            ...
            toast.dismiss();
            toast.error('Failed to update serviceAdvisor');
        }
    }
                            ...
                            <Col>
                                <Card>
                                    <Card.Header className="bg-primary text-white">
                                        <Card.Title className="mb-0">Edit service advisor</Card.Title>
                                    </Card.Header>
                                    <Card.Body>
                                        <Form>
                                            <Row >
...
export default EditServiceAdvisor;